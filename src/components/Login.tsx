...
export function Login() {
  ...
  return (
    <div className="relative bg-white w-[600px] shadow-xl flex flex-col items-start rounded-lg gap-5 py-9 px-10 m-auto">
      <img
      ...
      <form className="w-full flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-[22px]">
          ...
          <span className="text-[#ABABAB] text-center text-lg">{t("or")}</span>
